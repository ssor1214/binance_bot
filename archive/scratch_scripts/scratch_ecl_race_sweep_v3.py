...
OUT_RAW = Path("archive/scratch_scripts/ecl_race_sweep_v3_raw.json")
OUT_SUMMARY = Path("archive/scratch_scripts/ecl_race_sweep_v3_summary.json")

MULT_VARIANTS = [0.5, 0.6, 0.7, 0.8, 0.9, 1.0]
